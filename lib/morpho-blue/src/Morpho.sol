...
import {console2 as console3} from "forge-std/console2.sol";
...
contract Morpho is IMorphoStaticTyping {
    ...
    function supply(
        ...
        console3.log("Tot borrow shares before supply", market[id].totalSupplyShares);
        console3.log("Tot borrow assets before supply", market[id].totalSupplyAssets);

        position[id][onBehalf].supplyShares += shares;
        market[id].totalSupplyShares += shares.toUint128();
        market[id].totalSupplyAssets += assets.toUint128();

        console3.log("Tot borrow shares after supply", market[id].totalSupplyShares);
        console3.log("Tot borrow assets after supply", market[id].totalSupplyAssets);
    ...
    function withdraw(
        ...
        console3.log("market[id].totalBorrowAssets", market[id].totalBorrowAssets);
        console3.log("market[id].totalSupplyAssets", market[id].totalSupplyAssets);
    ...
    function repay(
        ...
        console3.log("Tot borrow shares before pay", market[id].totalBorrowShares);
        console3.log("Tot borrow assets before pay", market[id].totalBorrowAssets);

        if (assets > 0) shares = assets.toSharesDown(market[id].totalBorrowAssets, market[id].totalBorrowShares);
        else assets = shares.toAssetsUp(market[id].totalBorrowAssets, market[id].totalBorrowShares);

        console3.log("Repay ", position[id][onBehalf].borrowShares, shares.toUint128());
        position[id][onBehalf].borrowShares -= shares.toUint128();
        market[id].totalBorrowShares -= shares.toUint128();
        market[id].totalBorrowAssets = UtilsLib.zeroFloorSub(market[id].totalBorrowAssets, assets).toUint128();

        console3.log("Tot borrow shares after pay", market[id].totalBorrowShares);
        console3.log("Tot borrow assets after pay", market[id].totalBorrowAssets);
